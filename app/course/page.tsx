            ...
            <section className="relative pt-32 pb-20 px-6 md:px-12 bg-gradient-to-b from-stone-200 to-stone-50">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-gold font-serif text-lg tracking-widest uppercase mb-8">
                            講座・サービス一覧
                        </p>
                ...
                <div className="max-w-6xl mx-auto space-y-24">
                    ...
                    >
                        <div className="order-2 lg:order-1 space-y-6">
                            <motion.div variants={itemVariants} className="inline-block px-4 py-1 bg-stone-200 rounded-full text-stone-600 text-xs tracking-widest uppercase">
                                Step 1
                            </motion.div>
                            <motion.h2 variants={itemVariants} className="font-serif text-3xl md:text-4xl text-stone-800">
                                自己解放ベーシック講座
                            </motion.h2>
                            <motion.p variants={itemVariants} className="text-stone-600 leading-relaxed">
                            ...
                            <motion.ul variants={itemVariants} className="space-y-3 pt-4">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span className="text-stone-700">自分の思考の癖を知るワーク</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="w-5 h-5 text-gold flex-shrink-0 mt-0.5" />
                                    <span className="text-stone-700">感情デトックスセッション</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="w-5 h-5 text-gold flex-shrink-0 mt-0.5" />
                                    <span className="text-stone-700">理想の未来を描くビジョンマップ作成</span>
                                </li>
                            </motion.ul>
                            ...
                            <motion.div variants={itemVariants} className="pt-6 grid grid-cols-2 gap-4">
                                <div className="bg-white p-4 rounded-lg border border-stone-100 flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs text-stone-400">期間</p>
                                        <p className="font-medium text-stone-800">1ヶ月 (全3回)</p>
                                    </div>
                                </div>
                                <div className="bg-white p-4 rounded-lg border border-stone-100 flex items-center gap-3">
                                    <Zap className="w-5 h-5 text-stone-400" />
                                    <div>
                                        <p className="text-xs text-stone-400">形式</p>
                                        <p className="font-medium text-stone-800">オンライン / 録画</p>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            <motion.div variants={itemVariants} className="inline-block px-4 py-1 bg-gold/20 text-gold rounded-full text-xs tracking-widest uppercase">
                                Most Popular
                            </motion.div>
                            <motion.h2 variants={itemVariants} className="font-serif text-3xl md:text-4xl text-stone-800">
                                ライフシフト実践アカデミー
                            ...
                            <motion.ul variants={itemVariants} className="space-y-3 pt-4">
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="w-5 h-5 text-gold flex-shrink-0 mt-0.5" />
                                    <span className="text-stone-700">月2回のマンツーマンコンサルティング</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="w-5 h-5 text-gold flex-shrink-0 mt-0.5" />
                                    <span className="text-stone-700">無制限チャットサポート</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="w-5 h-5 text-gold flex-shrink-0 mt-0.5" />
                                    <span className="text-stone-700">オリジナルブランディング構築</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="w-5 h-5 text-gold flex-shrink-0 mt-0.5" />
                                    <span className="text-stone-700">コミュニティ参加権</span>
                                </li>
                            </motion.ul>
                            ...
                            <motion.div variants={itemVariants} className="pt-6 grid grid-cols-2 gap-4">
                                <div className="bg-white p-4 rounded-lg border border-stone-100 flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs text-stone-400">期間</p>
                                        <p className="font-medium text-stone-800">3ヶ月 / 6ヶ月</p>
                                    </div>
                                </div>
                                <div className="bg-white p-4 rounded-lg border border-stone-100 flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs text-stone-400">形式</p>
                                        <p className="font-medium text-stone-800">対面 & オンライン</p>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
            ...
            <section className="py-20 px-6 bg-white">
                <div className="max-w-4xl mx-auto">
                    <h2 className="font-serif text-3xl md:text-4xl text-stone-800 mb-16 text-center">
                        Flow to Start <br />
                        <span className="text-base text-stone-500 font-sans font-normal tracking-wide mt-2 block">受講までの流れ</span>
                    </h2>
                        ...
                        <div className="space-y-12">
                            {[
                                ...
                                <div key={i} className={`relative flex gap-8 items-start ${i % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}>
                                    {/* Number Bubble */}
                                    <div className="relative z-10 w-8 h-8 rounded-full bg-gold text-white flex items-center justify-center font-bold text-sm flex-shrink-0 md:absolute md:left-1/2 md:top-0 md:-ml-4">
                                        {i + 1}
                                    </div>

                                    {/* Content */}
                                    <div className={`flex-1 md:w-1/2 ${i % 2 === 0 ? "md:text-right md:pr-12" : "md:pl-12"}`}>
                                        <h3 className="font-serif text-xl text-stone-800 mb-2">{step.title}</h3>
